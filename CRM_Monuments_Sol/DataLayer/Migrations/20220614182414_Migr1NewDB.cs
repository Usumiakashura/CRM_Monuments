...
{
    public partial class Migr1NewDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stellas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Stellas_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StellaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deceaseds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Deceaseds_Stellas_StellaId",
                        column: x => x.StellaId,
                        principalTable: "Stellas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypeTextId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Epitaphs_Deceaseds_DeceasedId",
                        column: x => x.DeceasedId,
                        principalTable: "Deceaseds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Epitaphs_TypeTexts_TypeTextId",
                        column: x => x.TypeTextId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedallionMaterialId = table.Column<int>(type: "int", nullable: true),
                    SizeMedallion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShapeMedallionId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PhotoOnMonuments_MedallionMaterials_MedallionMaterialId",
                        column: x => x.MedallionMaterialId,
                        principalTable: "MedallionMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PhotoOnMonuments_ShapeMedallions_ShapeMedallionId",
                        column: x => x.ShapeMedallionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateBeginTextOnStella = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateCompleatTextOnStella = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeadLine = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DeceasedId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextOnStellas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TextOnStellas_Deceaseds_DeceasedId",
                        column: x => x.DeceasedId,
                        principalTable: "Deceaseds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TextOnStellas_TypeTexts_TypeTextId",
                        column: x => x.TypeTextId,
                        principalTable: "TypeTexts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deceaseds_StellaId",
                table: "Deceaseds",
                column: "StellaId");

            migrationBuilder.CreateIndex(
                name: "IX_Epitaphs_DeceasedId",
                table: "Epitaphs",
                column: "DeceasedId");

            migrationBuilder.CreateIndex(
                name: "IX_Epitaphs_TypeTextId",
                table: "Epitaphs",
                column: "TypeTextId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhotoOnMonuments_MedallionMaterialId",
                table: "PhotoOnMonuments",
                column: "MedallionMaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_PhotoOnMonuments_ShapeMedallionId",
                table: "PhotoOnMonuments",
                column: "ShapeMedallionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stellas_ContractId",
                table: "Stellas",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_TextOnStellas_DeceasedId",
                table: "TextOnStellas",
                column: "DeceasedId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TextOnStellas_TypeTextId",
                table: "TextOnStellas",
                column: "TypeTextId");
        }
